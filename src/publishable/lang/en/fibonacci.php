...
return [
    ...
    'database' => [
        ...
        'api_info'                  => 'API options',
        'api_code'                  => 'Custom Code',
        ...
        'delete_table_bread_conf'   => 'Yes, remove it',
        'delete_table_api_conf'     => 'Yes, remove the API',
        'delete_table_bread_quest'  => 'Are you sure you want to delete the BREAD for the :table table?',
        'delete_table_api_quest'    => 'Are you sure you want to delete the API for the :table table?',
        ...
        'edit_api_for_table'        => 'Edit API for :table table',
        'edit_rows'                 => 'Edit the rows for the :table table below',
        'edit_api'                  => 'Enable and config API :table table below',
        'api_enable'                => 'Enable',
        'api_secure'                => 'Secure',
        'edit_api_button'           => 'Config API',
        ...
        'error_creating_api'        => 'Sorry it appears there may have been a problem creating this API',
        ...
        'error_updating_api'        => 'Sorry it appears there may have been a problem updating this API',
        'error_removing_api'        => 'Sorry it appears there may have been a problem removing this API',
        'extra'                     => 'Extra',
        'field'                     => 'Field',
        'security_api'              => 'Protect API',
